...
fn main() -> BError {
    let context = BTermBuilder::new()
        .with_font("../resources/spritesheet.png", 32, 32)
        .with_simple_console(SCREEN_WIDTH, SCREEN_HEIGHT, "../resources/spritesheet.png")
        .with_fancy_console(SCREEN_WIDTH, SCREEN_HEIGHT, "../resources/spritesheet.png")
